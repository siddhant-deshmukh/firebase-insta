...
const NavBar = () => {
   ...
   return (
      <div className="pb-4 hidden fixed top-0 left-0 sm:flex flex-col  rounded bg-white border-r  border-r-gray-300  dark:bg-gray-800 h-screen justify-between ">
         <div className='w-fit lg:w-56'>
            <Link to={'/'} className="flex items-center w-full pl-4   py-7 mb-5 h-fit  place-content-start">
               <svg aria-label="Instagram" className="_ab6- hidden lg:flex" color="#262626" fill="#262626" height="29" role="img" viewBox="32 4 113 32" width="103">
               ...
               <svg aria-label="Instagram" className="_ab6- hidden sm:flex lg:hidden" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img" viewBox="0 0 24 24" width="24">
            ...
            <ul className="space-y-2  pl-2 ">
               <li>
                  <NavLink to='/' className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                     ...
                     <span className="ml-3 hidden lg:flex">Home</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Home
                     </div>
                  </NavLink>
               </li>
               <li>
                  <NavLink to="#" className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                     ...
                     <span className="flex-1 ml-3 whitespace-nowrap hidden lg:flex">Search</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Search
                     </div>
                  </NavLink>
               ...
               <li>
                  <NavLink to="/#" className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                     ...
                     <span className="flex-1 ml-3 whitespace-nowrap hidden lg:flex">Explore</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Explore
                     </div>
                  </NavLink>
               ...
               <li>
                  <NavLink to="#" className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                     ...
                     <span className="flex-1 ml-3 whitespace-nowrap hidden lg:flex">Reels</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Reels
                     </div>
                  </NavLink>
               ...
               <li>
                  <NavLink to="#" className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                     ...
                     <span className="flex-1 ml-3 whitespace-nowrap hidden lg:flex ">Messages</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Messages
                     </div>
                  </NavLink>
               ...
               <li>
                  <NavLink to="#" className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                     ...
                     <span className="flex-1 ml-3 whitespace-nowrap hidden lg:flex">Notification</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Notification
                     </div>
                  </NavLink>
               ...
               <li>
                  <button
                     className="group relative flex w-full text-center items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700"
                     ...
                     <span className="flex-1 ml-3 text-left whitespace-nowrap hidden lg:flex">Create</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Create
                     </div>
                  </button>
               ...
               <li>
                  <NavLink to={`/u/${authState.user?.uid}`} className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                     {/* <svg aria-label="Messenger" className="w-6 h-6" color="#262626" fill="#262626"  role="img" viewBox="0 0 24 24" ><path d="M12.003 2.001a9.705 9.705 0 1 1 0 19.4 10.876 10.876 0 0 1-2.895-.384.798.798 0 0 0-.533.04l-1.984.876a.801.801 0 0 1-1.123-.708l-.054-1.78a.806.806 0 0 0-.27-.569 9.49 9.49 0 0 1-3.14-7.175 9.65 9.65 0 0 1 10-9.7Z" fill="none" stroke="currentColor" strokeMiterlimit="10" strokeWidth="1.739"></path><path d="M17.79 10.132a.659.659 0 0 0-.962-.873l-2.556 2.05a.63.63 0 0 1-.758.002L11.06 9.47a1.576 1.576 0 0 0-2.277.42l-2.567 3.98a.659.659 0 0 0 .961.875l2.556-2.049a.63.63 0 0 1 .759-.002l2.452 1.84a1.576 1.576 0 0 0 2.278-.42Z" fillRule="evenodd"></path></svg> */}
                     <img src={authState.user?.avatarUrl || '/abstract-user.svg'} className="w-7 h-7 rounded-full" />
                     <span className="flex-1 ml-3 whitespace-nowrap hidden lg:flex">Profile</span>
                     <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                        Your Profile
                     </div>
                  </NavLink>
         ...
         <ul className='pl-3'>
            <li>
               ...
               >
                  ...
                  <span className="flex-1 ml-3 text-left whitespace-nowrap hidden lg:flex">Log out</span>
                  <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                     Logout
                  </div>
               </button>
               <NavLink to="/settings" className="group relative flex items-center p-2 text-sm font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <span className="flex-1 ml-3 whitespace-nowrap hidden lg:flex">Settings</span>
                  <div className='absolute hidden group-hover:block group-hover:lg:hidden  left-12 px-1 py-0.5 bg-white shadow-md  border border-gray-300 rounded-lg z-30'>
                     Settings
                  </div>
               </NavLink>
