...
const BottomNavbar = () => {
  ...
  return (
    <footer className='fixed flex sm:hidden  bg-white bottom-0 w-full rounded-t-xl  justify-between items-center border border-gray-300 px-2  z-10'>
      <NavLink to='/' className="p-2.5 text-sm font-normal text-gray-900 rounded-full dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <button
        ...
        className="p-2.5 text-sm font-normal text-gray-900 rounded-full dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <NavLink to="/settings" className="p-2.5 text-sm font-normal text-gray-900 rounded-full dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
        {/* Settings */}
      ...
      <NavLink to={`/u/${authState.user?.uid}`} className="p-2.5 text-sm font-normal text-gray-900 rounded-full dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
        {/* Your Profile */}
