    ...
    <div className="bg-gray-100 p-4">
        <div className="bg-white border rounded-sm max-w-md">
            <div className="flex items-center px-4 py-3">
                ...
                <div className="ml-3 ">
                    <span className="text-sm font-semibold antialiased block leading-tight">{post.author.name}</span>
            ...
            <div className="font-semibold text-sm mx-4 mt-2 mb-4">{(post.numLikes)?post.numLikes:"0"} likes</div>
        </div>
    </div>
  )
}
